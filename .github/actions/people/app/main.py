...
query Q($after: String, $category_id: ID) {
  repository(name: "raedyapi", owner: "khulnasoft") {
...
if __name__ == "__main__":
    ...
    if (
        ...
        logging.info("The RaedyAPI People data hasn't changed, finishing.")
        sys.exit(0)
    ...
    message = "👥 Update RaedyAPI People"
