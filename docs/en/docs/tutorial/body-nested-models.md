...
With **RaedyAPI**, you can define, validate, document, and use arbitrarily deeply nested models (thanks to Pydantic).
...
This would mean that **RaedyAPI** would expect a body similar to:
...
Again, doing just that declaration, with **RaedyAPI** you get:
...
With **RaedyAPI** you have the maximum flexibility provided by Pydantic models, while keeping your code simple, short and elegant.
