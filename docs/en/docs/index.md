...
<p align="center">
<a href="https://github.com/khulnasoft/raedyapi/actions?query=workflow%3ATest+event%3Apush+branch%3Amaster" target="_blank">
    <img src="https://github.com/khulnasoft/raedyapi/workflows/Test/badge.svg?event=push&branch=master" alt="Test">
</a>
<a href="https://coverage-badge.samuelcolvin.workers.dev/redirect/khulnasoft/raedyapi" target="_blank">
    <img src="https://coverage-badge.samuelcolvin.workers.dev/khulnasoft/raedyapi.svg" alt="Coverage">
</a>
...
<a href="https://pypi.org/project/raedyapi" target="_blank">
    <img src="https://img.shields.io/pypi/pyversions/raedyapi.svg?color=%2334D058" alt="Supported Python versions">
</a>
</p>

---

**Documentation**: <a href="https://raedyapi.khulnasoft.com" target="_blank">https://raedyapi.khulnasoft.com</a>

**Source Code**: <a href="https://github.com/khulnasoft/raedyapi" target="_blank">https://github.com/khulnasoft/raedyapi</a>
...
RaedyAPI is a modern, fast (high-performance), web framework for building APIs with Python 3.7+ based on standard Python type hints.
...
"_If anyone is looking to build a production Python API, I would highly recommend **RaedyAPI**. It is **beautifully designed**, **simple to use** and **highly scalable**, it has become a **key component** in our API first development strategy and is driving many automations and services such as our Virtual TAC Engineer._"
...
**Cligenius** is RaedyAPI's little sibling. And it's intended to be the **RaedyAPI of CLIs**. ⌨️ 🚀

## Requirements

Python 3.7+

RaedyAPI stands on the shoulders of giants:
...
If you don't know, check the _"In a hurry?"_ section about <a href="https://raedyapi.khulnasoft.com/async/#in-a-hurry" target="_blank">`async` and `await` in the docs</a>.
...
Coming back to the previous code example, **RaedyAPI** will:
...
For a more complete example including more features, see the <a href="https://raedyapi.khulnasoft.com/tutorial/">Tutorial - User Guide</a>.
...
To understand more about it, see the section <a href="https://raedyapi.khulnasoft.com/benchmarks/" class="internal-link" target="_blank">Benchmarks</a>.
...
- <a href="https://pyyaml.org/wiki/PyYAMLDocumentation" target="_blank"><code>pyyaml</code></a> - Required for Starlette's `SchemaGenerator` support (you probably don't need it with RaedyAPI).
- <a href="https://github.com/esnme/ultrajson" target="_blank"><code>ujson</code></a> - Required if you want to use `UJSONResponse`.

Used by RaedyAPI / Starlette:

- <a href="https://www.uvicorn.org" target="_blank"><code>uvicorn</code></a> - for the server that loads and serves your application.
- <a href="https://github.com/ijl/orjson" target="_blank"><code>orjson</code></a> - Required if you want to use `ORJSONResponse`.

You can install all of these with `pip install "raedyapi[all]"`.
